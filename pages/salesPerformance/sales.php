...
<body>
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class="boxes">
                    ...
                    <a href="chooseFranchisee?/DineIn" class="box box2">
                        <i class='bx bx-restaurant'></i>
                        <span class="text">Dine-In</span>
                    </a>
                    <a href="chooseFranchisee?/TakeOut" class="box box3">
                        <i class='bx bx-walk'></i>
                        <span class="text">Take-Out</span>
                    </a>
                    <a href="chooseFranchisee?/Delivery" class="box box4">
    ...
    <script src="../../assets/js/sales-script.js"></script>
</body>
