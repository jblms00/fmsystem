...
<body>
    ...
    <header class="contractheader">
        <div class="container-header">
            <h1 class="title">Take-Out Sales</h1>
        </div>
    </header>
