        ...
        <div class="activity">
            <section id="employees-section">
                    ...
                    <tbody>
                        ...
                        if ($data['status'] === 'success') {
                            foreach ($data['employees'] as $employee) {
                                ...
                                echo "<tr>";
                                echo "<td><input type='checkbox' class='employee-checkbox' data-user-id='" . htmlspecialchars($employee['user_id']) . "'></td>";
                ...
                <div class="text-center mt-5">
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary assign-now"
                            data-ac-id="<?php echo htmlspecialchars($id); ?>"
                            data-store="<?php echo $franchisee ?>">Assign</button>
