        ...
        <form id="leasing-document-form">
                ...
                <div class="input-field">
                    <div class="form-row">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="classification" name="classification" class="notarizationInput" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="percentage-rent" name="percentageRent" class="notarizationInput" step="any" required>
                        </div>
                        <div class="input-group">
                            <label for="minimum-rent" class="subLabel">Minimum Rent (PHP/sqm):</label>
                            <input type="number" id="minimum-rent" name="minimumRent" class="notarizationInput" step="any" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group-1">
                ...
                <div class="form-group payment-details">
                    ...
                    <textarea id="total-monthly-dues-note" name="totalMonthlyDues" placeholder="Add a note..."></textarea>
                    ...
                    <div class="form-row">
                        <div class="input-group">
                            ...
                            <div class="location-input">
                                <input type="text" id="lessor-address" name="lessorAddress" placeholder="Search location...">
                        ...
                        <div class="input-group">
                            ...
                            <div class="location-input">
                                <input type="text" id="lessee-address" name="lesseeAddress" placeholder="Search location...">
                                <i class="bx bx-search-alt icon"></i>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group button-group">
                <button type="button" id="save-draft-button-leasing" class="myButton save-draft-button">Save Draft</button>
